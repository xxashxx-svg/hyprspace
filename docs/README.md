...
| [ARCHITECTURE.md](./ARCHITECTURE.md) | How the tricky subsystems work: Loops + the headless agent runner, the integrated editor, startup services, PTY lifecycle, stores, persistence, auth. |
