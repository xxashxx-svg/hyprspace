...
| [ARCHITECTURE.md](./ARCHITECTURE.md) | How the tricky subsystems work: the chat engine, orchestrator, Loops + headless agent runner, the multi-agent launcher, the integrated editor, startup services, PTY lifecycle, stores, persistence, auth. |
